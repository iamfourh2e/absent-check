    ...
    <v-card>
        ...
        <v-card-text>
            <v-form v-model="valid" ref="form" lazy-validation>
                <v-flex xs6>
                    <v-select prepend-icon="date_range" label="Multiple select" v-bind:items="days" item-text="name"
                              v-model="exceptionDays" multiple chips hint="Select exception days"
                              persistent-hint></v-select>
                </v-flex>
                <v-layout row wrap>
                    <v-flex xs6 sm5>
                        <v-menu lazy :close-on-content-click="false" v-model="menuDayOffStart"
                                transition="scale-transition" offset-y full-width :nudge-right="40" max-width="290px"
                                min-width="290px">
                            <v-text-field slot="activator" label="Days off start" v-model="dayOffStart"
                    ...
                    <v-flex xs6 sm5>
                        <v-menu lazy :close-on-content-click="false" v-model="menuDayOffEnd"
                                transition="scale-transition" offset-y full-width :nudge-right="40" max-width="290px"
                                min-width="290px">
                            <v-text-field slot="activator" label="Days off end" v-model="dayOffEnd" prepend-icon="event"
                ...
                <v-layout row wrap>
                    <v-flex xs6 sm5>
                        <v-menu lazy :close-on-content-click="false" v-model="menuHoliday" transition="scale-transition"
                                offset-y full-width :nudge-right="40" max-width="290px" min-width="290px">
                            <v-text-field slot="activator" label="Holidays" v-model="holiday" prepend-icon="event"
                                          readonly></v-text-field>
